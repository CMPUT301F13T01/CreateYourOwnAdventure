...
/**
 * The StoryInfoListAdapter class is the ArrayAdapter for the StoryInfo list. It
 * is in charge of displaying the title and author of each story according to a
 * pre-defined format on the main selection screen.
 * 
...
public class StoryInfoListAdapter extends ArrayAdapter<StoryInfo> {
	 ...
	 * 
	 * @param context
	 *            The context for the adapter (the activity)
	 * @param layoutResourceId
	 *            The resource ID of the layout
	 * @param storyInfoList
	 *            The ArrayList of StoryInfo objects to display
	 */
	public StoryInfoListAdapter(Context context, int layoutResourceId,
			ArrayList<StoryInfo> storyInfoList) {
