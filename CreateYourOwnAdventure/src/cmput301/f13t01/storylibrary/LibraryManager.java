...
/**
 * This interface is designed to interact with stored stories. It is implemented
 * for both ElasticSearch and LocalManagers. Saving, Loading, and Deleting are
 * handled.
 * 
 * @author Jesse Chu
 * 
...
public interface LibraryManager {
	...
	/**
	 * Method to return an ArrayList of all StoryInfo that can be requested.
	 * 
	 ...
	 * 
	 * @param id
	 *            the ID to save the Story under
	 * @param story
	 *            the Story to save
	 * @return true if successful, false otherwise
	 */
