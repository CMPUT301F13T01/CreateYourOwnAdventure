/*
Sound class for CreateYourOwnAdventure.
...
public class Sound implements Media<String>, Serializable {
	public static final MediaType type = MediaType.SOUND;
	...
	/**
	 * Gets the <code>MediaInteractionManager</code> of the sound.
	 * 
	 * @return the sound's <code>MediaInteractionManager</code>.
	 */
	@Override
	...
	/**
	 * Sets the <code>MediaInteractionManager</code> of the Sound.
	 * 
	 * @param manager
