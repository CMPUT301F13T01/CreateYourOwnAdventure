...
/**
 * An instance of this class exists when a story is created, keeping track of
 * which fragment was last viewed in read mode by a user.
 * 
...
public class History implements Serializable {
	...
	/**
	 * Returns the most recently-viewed fragment, or null if the stack is empty.
	 * 
	...
	/**
	 * Pops the latest-viewed fragment from the stack and returns the id of the
	 * next most recently viewed fragment. If on the first-viewed fragment,
	 * returns null. If stack is empty, returns null.
	 * 
	...
	/**
	 * Pushes the newest fragment being viewed to the stack, if the most recent
	 * fragment is not at the top of the stack.
	 * 
	 * @param fragment_id
	 *            ID of fragment to be pushed to stack.
	 */
	public void pushToStack(Integer fragmentId) {
		...
		if (mostRecent != null) {
			if (!fragmentId.equals(mostRecent)) {
	...
	/**
	 * Writes the Serializable historyStack object to a file.
	 * 
	 * @param out
	...
	/**
	 * Reads the Serializable historyStack object from a file.
	 * 
	 * @param in
