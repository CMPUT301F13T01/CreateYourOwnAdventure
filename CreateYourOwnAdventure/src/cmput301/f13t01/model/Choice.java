...
/**
 * This is a simple object that will contain the information related to a
 * particular choice, which will allow the transition from one fragment to
...
public class Choice implements Serializable {
	 ...
	 * 
	 * @param sourceId
	 *            ID of choice's source story fragment.
	 * @param destinationId
	 *            ID of choice's destination story fragment.
	 * @param flavourText
	 *            Flavour text of choice
	 */
	 ...
	 * 
	 * @param sourceId
	 *            the fragment's source ID to set
	 */
	 ...
	 * 
	 * @param destinationId
	 *            the fragment's destination ID to set
	 */
