...
/**
 * FragmentList, holds all Fragment objects and gives each a unique ID. Every
 * Story object should have one of these.
 * 
...
public class StoryFragmentList implements Serializable {
	...
	/**
	 * Returns requested Fragment from FragmentList. Bad request returns null.
	 * 
	 * @param id
	 *            ID of requested Fragment
	 * @return the Fragment associated with the given ID, null if it doesn't
	 *         exist
	 */
	...
	public Integer getFragmentId(StoryFragment fragment) {
		...
		Set<Map.Entry<Integer, StoryFragment>> set = this.fragmentList
				.entrySet();
	...
	public ArrayList<StoryFragmentInfo> getFragmentInfoList() {
		...
		for (Map.Entry<Integer, StoryFragment> entry : this.fragmentList
				.entrySet()) {
