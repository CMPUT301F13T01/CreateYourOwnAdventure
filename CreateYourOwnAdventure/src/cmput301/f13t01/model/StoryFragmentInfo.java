...
/**
 * StoryFragmentInfo class, used to represent StoryFragments in a list. For use
 * of views that list StoryFragment objects.
 * 
...
public class StoryFragmentInfo {
	 ...
	 * 
	 * @param fragment
	 *            the StoryFragment to get the info of
	 */
